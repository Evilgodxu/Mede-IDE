package com.medeide.jh.core.ai
...
class InputOptimizer(
    private val cloudLLMClient: com.medeide.jh.data.source.remote.CloudLLMClient? = null,
    private val liteRTManager: com.medeide.jh.data.source.local.LiteRTManager? = null,
) {
...
如果输入已经足够好，直接输出原文本。"""
    ...
    suspend fun optimizeWithCloud(
        text: String,
        mode: Mode,
        config: com.medeide.jh.model.chat.CloudModelConfig,
    ): String {
        val client = cloudLLMClient ?: return text
        val historyMessages = listOf(
            com.medeide.jh.model.chat.ChatMessage(
                role = com.medeide.jh.model.chat.ChatRole.User,
                content = text,
            )
        )
