package com.medeide.jh.data.repository
...
class UserPreferencesRepository(private val context: Context) {
    ...
    val cloudModelProfiles: Flow<List<com.medeide.jh.model.chat.CloudModelProfile>> = context.dataStore.data
        .map { prefs ->
            ...
            try {
                ...
                (0 until arr.length()).map { i ->
                    ...
                    com.medeide.jh.model.chat.CloudModelProfile(
                        id = obj.optString("id", ""),
    ...
    suspend fun setCloudModelProfiles(profiles: List<com.medeide.jh.model.chat.CloudModelProfile>) {
    ...
    val modelParams: Flow<com.medeide.jh.model.chat.ModelParams> = context.dataStore.data
        .map { prefs ->
            val json = prefs[PreferencesKeys.MODEL_PARAMS_JSON]
            if (json != null) {
                try {
                    val obj = JSONObject(json)
                    com.medeide.jh.model.chat.ModelParams(
                ...
                } catch (_: Exception) { com.medeide.jh.model.chat.ModelParams() }
            } else com.medeide.jh.model.chat.ModelParams()
        }

    suspend fun setModelParams(params: com.medeide.jh.model.chat.ModelParams) {
        context.dataStore.edit { prefs ->
            val obj = JSONObject()
