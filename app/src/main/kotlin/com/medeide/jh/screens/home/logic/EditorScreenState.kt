...
class EditorScreenState(
    ...
    var currentSearchMatches by mutableStateOf<List<com.medeide.jh.screens.home.model.SearchResultItem>>(emptyList())
    ...
    // 持久化搜索结果（面板收起再展开后仍保留）
    var persistentSearchResults by mutableStateOf<List<com.medeide.jh.screens.home.model.SearchResultItem>>(emptyList())
