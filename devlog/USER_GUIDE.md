...
# 创建项目
bash /sdcard/Download/mede_ide/android_dev_toolkit.sh create_project <应用名称> <包名> <模板类型>

# 编译 Debug
bash /sdcard/Download/mede_ide/android_dev_toolkit.sh build_debug <项目名称>

# 编译 Release
bash /sdcard/Download/mede_ide/android_dev_toolkit.sh build_release <项目名称>
...
# 创建 Kotlin 项目
bash /sdcard/Download/mede_ide/android_dev_toolkit.sh create_project MyApp com.example.myapp kotlin
